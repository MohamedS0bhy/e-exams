...
<head>
  ...
  <title>E-exams | Registration Page</title>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="{{url('/register')}}" method="post" onsubmit="return false" id="registerForm">
      @csrf
      ...
      <div class="form-group has-feedback">
        <input type="tel" name="phone_number" class="form-control" placeholder="Phone num" required>
        <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
